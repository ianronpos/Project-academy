...
{
  new (message_memory) interfaces::msg::Comando(_init);
}

void Comando_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::msg::Comando *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Comando_message_member_array[2] = {
  {
    ...
    offsetof(interfaces::msg::Comando, acc),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::msg::Comando, delta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::interfaces::msg::rosidl_typesupport_introspection_cpp::Comando_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, msg, Comando)() {
  return &::interfaces::msg::rosidl_typesupport_introspection_cpp::Comando_message_type_support_handle;
}
