...
static const _Comando_type_support_symbol_names_t _Comando_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Comando)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, msg, Comando)),
  }
};
...
get_message_type_support_handle<interfaces::msg::Comando>()
{
  return &::interfaces::msg::rosidl_typesupport_cpp::Comando_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces, msg, Comando)() {
  return get_message_type_support_handle<interfaces::msg::Comando>();
}
