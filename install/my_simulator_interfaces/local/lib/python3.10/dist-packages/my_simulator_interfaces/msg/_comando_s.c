...
bool my_simulator_interfaces__msg__comando__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_simulator_interfaces.msg._comando.Comando", full_classname_dest, 44) == 0);
  }
  my_simulator_interfaces__msg__Comando * ros_message = _ros_message;
  {  // acc
...
PyObject * my_simulator_interfaces__msg__comando__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_simulator_interfaces.msg._comando");
