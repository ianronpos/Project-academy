...
static const _Comando_type_support_symbol_names_t _Comando_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_simulator_interfaces, msg, Comando)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_simulator_interfaces, msg, Comando)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_simulator_interfaces, msg, Comando)() {
  return &::my_simulator_interfaces::msg::rosidl_typesupport_c::Comando_message_type_support_handle;
}
